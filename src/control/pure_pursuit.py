...
# Pure Pursuit parameters - tuned for CARLA  
param_K_dd = 0.4
...
class PurePursuitPlusPID:
    def __init__(self, pure_pursuit=None, pid=None):
        self.pure_pursuit = pure_pursuit if pure_pursuit else PurePursuit()
        self.pid = pid if pid else PIDController(param_Kp, param_Ki, param_Kd, 0)
